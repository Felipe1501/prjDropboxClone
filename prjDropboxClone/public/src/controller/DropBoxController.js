class DropBoxController {
    ...
    connectFirebase(){
        ...
        const firebaseConfig = {
            apiKey: "AIzaSyD3Gqo6YPHfpTO1tUJhko6GZKmN-rKw21s",
            authDomain: "dbdropboxfelipe.firebaseapp.com",
            databaseURL: "https://dbdropboxfelipe-default-rtdb.firebaseio.com",
            projectId: "dbdropboxfelipe",
            storageBucket: "dbdropboxfelipe.appspot.com",
            messagingSenderId: "146746128444",
            appId: "1:146746128444:web:941eb953531c4ca2a86b39",
            measurementId: "G-919DVX8BHV"
          };
        ...
        [...files].forEach(file => {
            ...
            promises.push(new Promise((resolve, reject) =>{
                ...
                task.on('state-changed', snapshot =>{
                    ...
                    flleRef.getMetadata().then(metadata =>{
                        resolve(metadata);
                    }).catch(err =>{
                        reject(err);
                    });
    ...
    //função para ler os arquivos no firebase
    readFiles(){
        ...
        this.getFirebaseRef().on('value', snapshot => {
            ...
            //vai limpar para colocar um novo html
    ...
    renderNav(){
        ...
        //variável que vai salvar o caminho para as pastas
        let path = [];
        ...
        for (let i = 0; i < this.currentFolder.length; i++){
            ...
            //conteúdo da span só vai receber o nome da pasta
        ...
        //copiando conteúdo do nav que está na memória, para o conteúdo do nav na tela
